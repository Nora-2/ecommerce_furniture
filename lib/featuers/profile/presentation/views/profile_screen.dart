      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //3-Card
            GestureDetector(
              onTap: () =>Navigator.of(context).pushNamed( paymentScreen.id) ,
              child: MyCard(
            ...
            //4-Card
            GestureDetector(
              onTap: () {Navigator.of(context).pushNamed(ReviewScreen.id);},
              child: MyCard(
            ...
            //5-Card
            GestureDetector(
              onTap:() {Navigator.of(context).pushNamed(settingScreen.id);},
              child: MyCard(
                titleChild: Strings.Setting.text,
                subtitleChild: "Notification, Password, FAQ, Contact",
              ),
            ),
          ],
        ),
